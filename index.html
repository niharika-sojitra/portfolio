    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="photos/my-image.jpg" alt="Profile Image"/></a></div>
          <div class="h2 title">Niharika Sojitra</div>
          <p class="category text-white">Machine Learning Engineer, Data Scientist, Web Developer & Designer</p>
          <!--a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a-->
          <a class="btn btn-primary" href="Niharika Sojitra Resume.pdf" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download Resume</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am Niharika Sojitra. Machine Learning Engineer, Data Scientist, Web Developer & Designer.</p>
            <p>A Passionate M.Sc. Computer Science graduate certified in Power BI and Tableau, specializing in ML and DL technologies like NLP, Pattern
              Recognition, Computer Vision, Data Mining, and ETL. With three years of hands-on expertise in WordPress web development, I excel in
              analytical skills, data analysis, and detail-oriented problem-solving. Eagerly embracing opportunities for continuous learning and growth
              in the dynamic world of technology.</p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8" href ="">nbsojitra@outlook.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">+1807-358-7105</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">LinkedIn:</strong></div>
              <div class="col-sm-8" href ="https://www.linkedin.com/in/niharikasojitra/">NiharikaSojitra</div>
            </div>
            <!--div class="row mt-3">
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5">Customize Theme</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Junior Web Developer and Designer</div>
            <p>
              <ul>
              <li>Led a team of 5 in developing visually appealing and responsive website themes and plugins, utilizing WordPress, PHP,
              HTML5, CSS3, and JavaScript.</li>
              <li>Conducted performance analysis and implemented optimization techniques such as image optimization and caching to reduce
              website loading times to 1-2 s.</li>
              <li>Executed SEO-driven content strategies, promptly identified and resolved issues through effective debugging, and ensured
              website functionality and responsiveness thorough testing.</li>
              <li>Received commendations for detailed documentation, ensuring seamless backups, deployments, and efficient time management
              across 20+ website iterations.</li>
              <li>Projects: <a href="#" target="_blank">Shiroya</a>, <a href="#" target="_blank">Radha</a>, <a href="#" target="_blank">Calid’s Food</a>, <a href="#" target="_blank">Harakh</a> etc.</li>
              </ul>
            </p>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5">Akash Technolabs</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Internship and Training</div>
            <p>eu etiam pretium molestie ultricies sollicitudin dui.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container cc-education">
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Master of Science, Computer Science</div>
            <p class="category">Lakehead University</p>
            <p>Euismod massa scelerisque suspendisse fermentum habitant vitae ullamcorper magna quam iaculis, tristique sapien taciti mollis interdum sagittis libero nunc inceptos tellus, hendrerit vel eleifend primis lectus quisque cubilia sed mauris. Lacinia porta vestibulum diam integer quisque eros pulvinar curae, curabitur feugiat arcu vivamus parturient aliquet laoreet at, eu etiam pretium molestie ultricies sollicitudin dui.</p>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Bachelor of Engineering, Information Technology</div>
            <p class="category">Gujarat Technological University</p>
            <p>Euismod massa scelerisque suspendisse fermentum habitant vitae ullamcorper magna quam iaculis, tristique sapien taciti mollis interdum sagittis libero nunc inceptos tellus, hendrerit vel eleifend primis lectus quisque cubilia sed mauris. Lacinia porta vestibulum diam integer quisque eros pulvinar curae, curabitur feugiat arcu vivamus parturient aliquet laoreet at, eu etiam pretium molestie ultricies sollicitudin dui.</p>
          </div>
        </div>
      </div>
